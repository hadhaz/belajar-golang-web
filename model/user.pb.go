...
type UserList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ListUser      []*User                `protobuf:"bytes,1,rep,name=listUser,proto3" json:"listUser,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserList) GetListUser() []*User {
	if x != nil {
		return x.ListUser
	}
	return nil
...
const file_model_user_proto_rawDesc = "" +
	...
	"\x06gender\x18\x04 \x01(\x0e2\x11.model.UserGenderR\x06gender\"3\n" +
	"\bUserList\x12'\n" +
	"\blistUser\x18\x01 \x03(\v2\v.model.UserR\blistUser*1\n" +
	"\n" +
	"UserGender\x12\r\n" +
...
var file_model_user_proto_depIdxs = []int32{
	...
	1, // 1: model.UserList.listUser:type_name -> model.User
